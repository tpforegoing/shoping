...
│   │   │   ├── dashboard/    # Дашборд
│   │   │   ├── orders/       # сторінки замовлень, та корзина
│   │   │   ├── price/        # Сторінки цін
│   │   │   └── product-details/ # Сторінки продуктів із цінами та вствновлення цін
│   │   │   └── products/     # Сторінки продуктів
│   │   ├── share/            # допоміжні функції для компонентів
│   │   ├── store/            # Глобальний стан
│   │   ├── themes/           # Глобальний кольорові налаштування
